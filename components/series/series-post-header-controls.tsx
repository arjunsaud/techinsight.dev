...
import { useSeriesPostStudioControls } from "@/components/series/series-post-studio-context";
import { Button } from "@/components/ui/button";

export function SeriesPostHeaderControls() {
  const { isSaving, isPreviewMode, saveDraft, savePublished, togglePreview } =
    useSeriesPostStudioControls();
